...
export default function AdminShell({
  ...
  return (
    <div className="flex h-screen bg-gray-100 overflow-hidden">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 bg-white border-r border-gray-200 flex flex-col transform transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static lg:z-auto ${
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 h-16 border-b border-gray-100 flex-shrink-0">
          ...
          <div className="min-w-0">
            <p className="text-sm font-bold text-gray-900 truncate">Pilkel Desa Pikat</p>
        ...
        <div className="border-t border-gray-100 px-3 py-3 flex-shrink-0">
          <div className="flex items-center gap-3 px-2 py-2">
            <div className="w-9 h-9 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 font-bold text-xs flex-shrink-0">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top Bar */}
        <header className="h-16 bg-white border-b border-gray-200 flex items-center px-4 sm:px-6 gap-4 flex-shrink-0">
          <button
