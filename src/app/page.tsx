          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-xl text-gray-900 placeholder-gray-400 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 ${clientError
          ...
          {result && result.success && result.notFound && (
            <div className="mt-6 pt-6 border-t border-gray-100 animate-fade-in-up">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-5 text-center">
                <h3 className="text-base font-bold text-red-900 mb-4">NIK anda tidak terdaftar dalam DPT Pemilihan Perbekel Desa Pikat.</h3>
                ...
                {result.whatsappUrl && (
                  ...
                  >
                    ...
                    Hubungi Panitia Pilkel Desa Pikat
                  </a>
                )}
              </div>
            </div>
